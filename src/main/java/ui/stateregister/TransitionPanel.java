...
public class TransitionPanel extends JPanel {
    ...
    public TransitionPanel(StateRegister stateRegister, Configuration config, Transition transition) {
        ...
        this.stateComboBox.setPreferredSize(new Dimension(55, 25));
        ...
        this.newSymbolComboBox.setPreferredSize(new Dimension(45, 25));
        ...
        this.moveComboBox.setPreferredSize(new Dimension(75, 25));
